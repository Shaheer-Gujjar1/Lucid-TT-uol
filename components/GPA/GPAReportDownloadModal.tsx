        ...
        <div id="gpa-report-view" style={styles.container}>
            ...
            <div style={styles.headerBlock}>
                ...
                <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ color: '#64748b', fontSize: '14px' }}>Generated by Lucid Aura∞ v6.11.5</div>
                </div>
            </div>
...
export default function GPAReportDownloadModal({ isOpen, onClose, semesters, cgpa, totalCredits, onToast }: GPAReportDownloadModalProps) {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            onToast(isClassic ? 'Report Downloaded!' : 'Report Downloaded Successfully!');
            onClose();
        } catch (e) {
            console.error("Download failed", e);
            onToast(isClassic ? 'Download failed.' : 'Failed to generate report.');
            onClose();
        } finally {
